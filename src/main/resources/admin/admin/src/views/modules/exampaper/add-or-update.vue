<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="试卷名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="试卷名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="试卷名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="试卷名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="试卷状态" prop="status">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="试卷状态" prop="status">
