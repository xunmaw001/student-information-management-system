	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程类型" prop="kechengleixing">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="选课人数" prop="kexuanrenshu">
					<el-select :disabled="ro.kexuanrenshu" v-model="ruleForm.kexuanrenshu" placeholder="请选择选课人数" >
						<el-option
							v-for="(item,index) in kexuanrenshuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="选课人数" prop="kexuanrenshu">
					<el-input v-model="ruleForm.kexuanrenshu"
						placeholder="选课人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="选课时间" prop="xuankeshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xuankeshijian" label="选课时间" prop="xuankeshijian">
					<el-input v-model="ruleForm.xuankeshijian" placeholder="选课时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学号" prop="xuehao">
					<el-input v-model="ruleForm.xuehao" placeholder="学号" clearable  :readonly="ro.xuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学院" prop="xueyuan">
					<el-input v-model="ruleForm.xueyuan" placeholder="学院" clearable  :readonly="ro.xueyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="学院" prop="xueyuan">
					<el-input v-model="ruleForm.xueyuan" placeholder="学院" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="班级" prop="banji">
					<el-input v-model="ruleForm.banji" placeholder="班级" clearable  :readonly="ro.banji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="班级" prop="banji">
					<el-input v-model="ruleForm.banji" placeholder="班级" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="选课说明" prop="xuankeshuoming">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="选课说明"
					  v-model="ruleForm.xuankeshuoming" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.xuankeshuoming" label="选课说明" prop="xuankeshuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xuankeshuoming}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				xuankeshuoming: [
					{ required: true, message: '选课说明不能为空', trigger: 'blur' },
				],
				gonghao: [
				],
				kexuanrenshu: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xuankeshuoming'){
							this.ruleForm.xuankeshuoming = obj[o];
							this.ro.xuankeshuoming = true;
							continue;
						}
						if(o=='gonghao'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.xueyuan!=''&&json.xueyuan) || json.xueyuan==0) && this.$storage.get("role")!="管理员"){
            ...
            this.kexuanrenshuOptions = "1".split(',')
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.kexuanrenshu = objcross.kexuanrenshu - this.ruleForm.kexuanrenshu
	      if(objcross.kexuanrenshu<0){
		this.$message.error("选课人数不足");
		return
	      }
                }
