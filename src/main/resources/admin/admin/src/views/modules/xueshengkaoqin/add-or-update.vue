<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="名称" prop="mingcheng">
					<el-input v-model="ruleForm.mingcheng" placeholder="名称" clearable  :readonly="ro.mingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="名称" prop="mingcheng">
					<el-input v-model="ruleForm.mingcheng" placeholder="名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="考勤日期" prop="kaoqinriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.kaoqinriqi" 
						type="date"
						:readonly="ro.kaoqinriqi"
						placeholder="考勤日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.kaoqinriqi" label="考勤日期" prop="kaoqinriqi">
					<el-input v-model="ruleForm.kaoqinriqi" placeholder="考勤日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xuehao" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="考勤状况" prop="kaoqinzhuangkuang">
					<el-select :disabled="ro.kaoqinzhuangkuang" v-model="ruleForm.kaoqinzhuangkuang" placeholder="请选择考勤状况" >
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="考勤状况" prop="kaoqinzhuangkuang">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教师姓名" prop="jiaoshixingming">
					<el-input v-model="ruleForm.jiaoshixingming" placeholder="教师姓名" clearable  :readonly="ro.jiaoshixingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="教师姓名" prop="jiaoshixingming">
					<el-input v-model="ruleForm.jiaoshixingming" placeholder="教师姓名" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="考勤说明" prop="kaoqinshuoming">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="考勤说明"
					  v-model="ruleForm.kaoqinshuoming" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kaoqinshuoming" label="考勤说明" prop="kaoqinshuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.kaoqinshuoming}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				kaoqinzhuangkuang: [
					{ required: true, message: '考勤状况不能为空', trigger: 'blur' },
				],
				kaoqinshuoming: [
					{ required: true, message: '考勤说明不能为空', trigger: 'blur' },
				],
				gonghao: [
				],
				jiaoshixingming: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='kaoqinshuoming'){
							this.ruleForm.kaoqinshuoming = obj[o];
							this.ro.kaoqinshuoming = true;
							continue;
						}
						if(o=='gonghao'){
